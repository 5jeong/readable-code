...
public class SeatPassFileReader implements SeatPassProvider {
    ...
    public static final String SEAT_LIST_CSV_PATH = "src/main/resources/cleancode/studycafe/pass-list.csv";

    @Override
    public StudyCafeSeatPasses getSeatPasses() {
        try {
            List<String> lines = Files.readAllLines(Paths.get(SEAT_LIST_CSV_PATH));
